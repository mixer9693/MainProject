...
spa.table.performer = (function () {
    ...
    var
        ...
        init, show, addSetPerformerClickListener, addRemovePerformerClickListener

    init = function ($container) {
        
        return new Promise(function (resolve, reject) {
            container = $container;
            $.get('spa/html/spa.table.performer.html').done(function (data) {
                html = data;
                resolve();

            }).fail(function (err) {
                console.log('performer > init: fail');
                throw Error(err);
                reject();
            });
        });
    ...
    getPerformer = function (id) {
        return new Promise(function (resolve, reject) {
            var url = id ? '/api/performer/for-manager/'+id
                :'/api/performer/for-manager?at_work=1&free=1';
